...
grViz("
  digraph G {
    ...
    subgraph cluster_data {
      ...
      filter_primary [label = 'Filter: Normal & Metastasis\nSamples (n = 481)']
      filter_clinical [label = 'Filter: Missing Clinical Data\n(n = 475: 225F, 250M)']
      normalization [label = 'RNA-seq Data Normalization\nand Filtering']
    ...
    subgraph cluster_prognostic {
      ...
      prognostic_markers [label = 'Clinically Significant\nPrognostic Markers']
